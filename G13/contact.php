						...
						<table>
							...
							<tr>
								<td></td><td colspan=2 id="buttons">
									<input type=reset value=Clear id="clear" style="display:none;"><img onclick="document.getElementById('clear').click()" src="images/Clear_Button.jpg" width="66px" height="20px"></input>
