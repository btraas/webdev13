		<div id='orderSummaryDetails'>
			<div class=underline><h2>Order Summary</h2>
			</div>
			<div id='orderSummary' class='blackList' >
				<table id='orderItems'>
					<!-- lineitems inserted here -->
					<tr class='total'><td colspan=2></td></tr>
				</table><table id='orderTotals'>
			...
			<div id='orderDetails'><table>
            	...
            	<tr><td colspan=2>
            	<input type=button id='clear' class='ui-button halfWidth' value=Clear />
                <input type=button id='submit1' class='ui-button halfWidth' value=Submit />
                </td></tr></table>
            </div>
			<div id='tmp' style='display: hidden;'></div>
		</div>
